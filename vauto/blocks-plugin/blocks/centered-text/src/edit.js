...
const BLOCK_TEMPLATE = [
	['core/group', { className: 'centered-text__flexible-inner' }, [
		['core/heading', { className: 'centered-text__heading h1', level: 2, textAlign: 'center', placeholder: 'Centered Heading' }],
		...
		['mx/buttons', { className: 'centered-text__links', layout: { type: 'flex', justifyContent: 'center' } }, [
			['mx/button', { className: 'centered-text__link', placeholder: 'Link Text' }]
		]]
	]]
];
