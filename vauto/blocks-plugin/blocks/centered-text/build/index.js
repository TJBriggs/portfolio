...
const BLOCK_TEMPLATE = [['core/group', {
  className: 'centered-text__flexible-inner'
}, [['core/heading', {
  className: 'centered-text__heading h1',
  level: 2,
  textAlign: 'center',
  placeholder: 'Centered Heading'
}], ['core/paragraph', {
  className: 'centered-text__text center-narrow',
  fontSize: 'large',
  align: 'center',
  placeholder: 'Centered text...morbi leo risus, porta ac consectetur ac, vestibulum at eros. Cras mattis consectetur purus sit amet fermentum. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum.'
}], ['mx/buttons', {
  className: 'centered-text__links',
  layout: {
    type: 'flex',
    justifyContent: 'center'
  }
}, [['mx/button', {
  className: 'centered-text__link',
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('mx/centered-text', {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkcentered_text"] = globalThis["webpackChunkcentered_text"] || [];
