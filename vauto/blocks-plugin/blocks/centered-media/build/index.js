...
const BLOCK_TEMPLATE = [['core/group', {
  className: 'centered-media__flexible-inner'
}, [['core/heading', {
  className: 'centered-media__heading h1',
  level: 2,
  textAlign: 'center',
  placeholder: 'Optional Heading'
}], ['core/paragraph', {
  className: 'centered-media__text center-narrow',
  fontSize: 'large',
  align: 'center',
  placeholder: 'Optional text...morbi leo risus, porta ac consectetur ac, vestibulum at eros. Cras mattis consectetur purus sit amet fermentum. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum.'
}], ['mx/media-block', {
  className: 'centered-media__media'
}]]]];
function Edit(_ref) {
  let {
    attributes: {
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('mx/centered-media', {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkcentered_media"] = globalThis["webpackChunkcentered_media"] || [];
