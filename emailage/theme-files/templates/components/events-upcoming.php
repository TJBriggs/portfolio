<article class="blog-feed blog-feed--events-upcoming blog-feed--accent-green blog-feed--pad-top blog-feed--pad-bot">
    <div class="blog-feed__inner">  
        <h4 class="blog-feed__colored-title">Upcoming Events</h4> 
        <?php 
            $event_args = array(
                'post_type' => 'events',
                'posts_per_page' => -1,
        ...
        <?php else : ?>
            <h2 style="text-align: center;">Sorry, no upcoming events are scheduled at this time.</h2>
        <?php endif; ?>
    </div>
</article>