...
gulp.task('critical-css', function() {
    ...
    gulp.src(config.critical.src+'*.scss')
        .pipe(stops(compass({
            sourcemap: true,
            quiet: true,
            css: config.critical.dest,
            sass: config.critical.src,
            image: config.critical.src+'../images',
            style: 'compressed',
            require: ['sass-globbing']
        }), {
            eachErrorCallback: function(){
...
gulp.task('watch', function() {
    ...
    // critical css watch
    gulp.watch(config.critical.src + '**/*.scss', ['critical-css']);
