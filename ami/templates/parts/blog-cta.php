<?php
	// Modifier Classes
	$special_class = get_field('content_modifiers', 'option');
	if($special_class){
	...
	$bgColor = get_field('bg_color', 'option');
	$bgModifier = ' cta-bar--' . $bgColor;
	// icon vars
	$cta_icon = get_field('cta_icon', 'option');
	// cta vars
	$cta_header = get_field('cta_header', 'option');
	$cta_text = get_field('cta_text', 'option');
	$cta_options = get_field('cta_btn_options', 'option');
	$cta_btn_text = get_field('cta_btn_text', 'option');
?>
