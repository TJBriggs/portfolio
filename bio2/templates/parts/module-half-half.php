...
?>
<article class="half-half<?php echo $classes; ?><?php echo $layout_mod; ?><?php echo $bg_mod; ?>">
    <?php if(get_sub_field('video_link')) : ?>
        ...
        ?>
        <a class="half-half__video fancybox-media <?php echo $bg_image['class']; ?>"" href="<?php the_sub_field('video_url') ?>">
    ...
    <?php else : ?>
        <div class="half-half__image <?php echo $bg_image['class']; ?>">
            <?php echo $bg_image['styles']; // echo the <style> tag ?>
        </div>
    <?php endif; ?>
    <div class="half-half__inner">
        <div class="half-half__content">
